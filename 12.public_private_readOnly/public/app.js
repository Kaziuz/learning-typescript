...
/*
class Invoice {
  readonly client: string // Podemos leerlo desde la clase o instaciada la clase pero no podemos cambiarlo
  private details: string // solo la clase la puede usar (leer y escribir),pero instanciada la clase no se puede usar
  public amount: number // se puede usar en la clase como instanciada la clase
